import { a as ace$1 } from "./theme-textmate.chunk.js";
...
function initializeAceEditor() {
  ...
  codeEditor = ace$1.edit("aceEditor");
...
// fetchData().then(data => console.log(data));`;
  ...
  languageSelect?.addEventListener("change", (e) => {
    ...
    const mode = target.value === "typescript" ? "ace/mode/typescript" : "ace/mode/javascript";
  ...
  themeSelect?.addEventListener("change", (e) => {
    const target = e.target;
    const theme = target.value === "textmate" ? "ace/theme/textmate" : "ace/theme/github";
